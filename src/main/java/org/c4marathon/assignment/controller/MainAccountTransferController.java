...
import org.c4marathon.assignment.service.MainAccountTransferService;
...
public class MainAccountTransferController {

	private final MainAccountTransferService mainAccountTransferService;

	@PostMapping("/transfer")
	public ResponseEntity<ApiResponse<String>> transfer(
		@RequestBody TransferRequestDto request
	) {
		mainAccountTransferService.transfer(request.fromMemberId(), request.toMemberId(), request.amount());
